...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12 text-center mt-5 t-font">
    ...
    <script>
    // Swiper instance for fading effect
    var swiperFade = new Swiper(".swiper-container", {
        spaceBetween: 30,
        effect: "fade",
        loop: true,
        autoplay: {
    ...
    // Swiper instance for testimonials with coverflow effect
