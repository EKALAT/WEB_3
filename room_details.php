...
<head>
    ...
    <title>PMS HOTEL - ROOM DETAILS</title>
            ...
            <div class="col-lg-4 col-md-12 px-4">
                <div class="card mb-4 border-0 shadow-sm rounded-3">
                    <div class="card-body">
                        ...
                        echo <<<price
                                <h4 class="mb-1">$room_data[price]$ per night</h4>
                        price;
                        ...
                        echo <<<area
                            ...
                            <span class='badge rounded-pill bg-light text-dark text-wrap t-font me-1 mb-1'>
                        ...
                        echo <<<book
                            <a href="confirm_booking.php?id=$room_data[id]" class="Book btn-sm text-white submit-bg shadow-none t-font mb-1">Book Now</a>
                        book;
